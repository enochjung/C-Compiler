...
{
  "$end", "error", "$undefined", "NEW_LINE", "COLON", "COMMA",
  "IDENTIFIER", "INST1", "INST2", "INTEGER", "FLOAT", "STRING", "CHAR",
  "GLOBAL_WORD_SYM", "GLOBAL_BYTE_SYM", "LITERAL_SYM", "$accept",
