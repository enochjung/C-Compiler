...
void prt_program(A_NODE *node, int s)
{
	...
	case N_PROGRAM:
		...
		break;
	default :
		printf("****syntax tree error prt_program******\n");
	}
}
void prt_initializer(A_NODE *node, int s)
{
	...
	case N_INIT_LIST_NIL:
		break;
	default :
		printf("****syntax tree error prt_initializer******\n");
	}
}
void prt_expression(A_NODE *node, int s)
{
	...
	case N_EXP_INT_CONST :
		prt_integer((int)(long)node->clink, s+1);
		break;
	...
	case N_EXP_ASSIGN :
		...
		break;
	default : 
		printf("****syntax tree error prt_expression******\n");
	}
}
void prt_arg_expr_list(A_NODE *node, int s)
{
	...
	case N_ARG_LIST_NIL : 
		break;
	default :
		printf("****syntax tree error prt_arg_expr_list******\n");
	}	
}
void prt_statement(A_NODE *node, int s)
{
	...
	case N_STMT_COMPOUND:
		if(node->llink) 
			prt_A_ID_LIST((A_ID*)node->llink, s+1);
	...
	case N_STMT_RETURN:
		...
		break;
	default :
		printf("****syntax tree error prt_statement******\n");
	}
}
void prt_statement_list(A_NODE *node, int s)
{
	...
	case N_STMT_LIST_NIL:
		break;
	default :
		printf("****syntax tree error prt_statemet_list******\n");
...
void prt_for_expression(A_NODE *node, int s)
{
	...
	case N_FOR_EXP :
		...
		break;
	default :
		printf("****syntax tree error prt_for_expression******\n");
	}
}
